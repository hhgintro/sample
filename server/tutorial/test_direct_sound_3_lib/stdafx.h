...
#ifdef DEBUG
	#ifdef _WIN64
		#pragma comment(lib, "../../bin/hisound/hisoundx64_d.lib")
	#else
		#pragma comment(lib, "../../bin/hisound/hisoundx86_d.lib")
	#endif //.._WIN64
#else
	#ifdef _WIN64
		#pragma comment(lib, "../../bin/hisound/hisoundx64.lib")
	#else
		#pragma comment(lib, "../../bin/hisound/hisoundx86.lib")
	#endif //.._WIN64
#endif //..DEEBUG
