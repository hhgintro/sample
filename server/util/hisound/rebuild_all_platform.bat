...
set SOLUTION_NAME="%cd%\hisound.sln"

%VS_PATH% %SOLUTION_NAME% /Clean "Debug|x86"
%VS_PATH% %SOLUTION_NAME% /Clean "Release|x86"
%VS_PATH% %SOLUTION_NAME% /Clean "Debug|x64"
%VS_PATH% %SOLUTION_NAME% /Clean "Release|x64"
rem pause

%VS_PATH% %SOLUTION_NAME% /Build "Debug|x86"
%VS_PATH% %SOLUTION_NAME% /Build "Release|x86"
