...
namespace FreeNet
{
    public class CNetworkService
    {
		...
		public void initialize()
		{
			...
			this.buffer_size = Defines.MSG_TOTAL_SIZE;
		...
		public void on_connect_completed(Socket socket, CUserToken token)
		{
			...
			receive_event_arg.SetBuffer(new byte[Defines.MSG_TOTAL_SIZE], 0, Defines.MSG_TOTAL_SIZE);
			...
			send_event_arg.SetBuffer(new byte[Defines.MSG_TOTAL_SIZE], 0, Defines.MSG_TOTAL_SIZE);
