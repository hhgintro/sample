...
namespace FreeNet
{
	...
	public class CConnector
	{
		...
		public ConnectedHandler signup_callback { get; set; }		//HG[2021.02.16]콜백위치를 sign_up 이후에서 처리합니다.
		...
		public CConnector(CNetworkService network_service)
		{
			...
			this.signup_callback = null;		//HG[2021.02.16]콜백위치를 sign_up 이후에서 처리합니다.
		}
		...
		void on_connect_completed(object sender, SocketAsyncEventArgs e)
		{
			if (e.SocketError == SocketError.Success)
			{
				...
				CUserToken token = new CUserToken(this);
